...
++++
<img src="{{ site.url }}{{ page.imagedir }}shell.png" alt="Shell started"/>
++++
...
++++
<img src="{{ site.url }}{{ page.imagedir }}project_command.png" alt="Project Command"/>
++++
...
++++
<img src="{{ site.url }}{{ page.imagedir }}homepage_application.png" alt="Home page" title="Home page" />
<img src="{{ site.url }}{{ page.imagedir }}create_page.png" alt="Create new owner page" title="Create new owner page" />
<img src="{{ site.url }}{{ page.imagedir }}list_page.png" alt="List all owners page" title="List all owners page" />
++++
