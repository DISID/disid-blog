    ...
    $.cookieCuttr = function (options) {
        ...
        if (($cookieAccepted) || ($cookieDeclined)) {
            ...
            if ((cookieNoMessage) && (!cookiePolicyPage)) {
                ...
                if (appOrPre) {
                    $('body').append('<div class="cc-cookies ' + cookieOverlay + '"><div class="col-lg-8 col-sm-6">' + cookieAnalyticsMessage + '</div><div class="col-lg-4 col-sm-6">' + cookieAccept + cookieDecline + '<a href="' + cookieWhatAreTheyLink + '" title="Ver política de cookies"><small>' + cookieWhatAreLinkText + '</small></a></div>');
                } else {
                    $('body').prepend('<div class="cc-cookies ' + cookieOverlay + '"><div class="col-lg-6 col-sm-6">' + cookieAnalyticsMessage + '</div><div class="col-lg-4 col-sm-6">' + cookieAccept + cookieDecline + '<a href="' + cookieWhatAreTheyLink + '" title="Ver política de cookies"><small>' + cookieWhatAreLinkText + '</small></a></div>');
                }
            }
